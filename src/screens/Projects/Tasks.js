...
import ProjectDetails from "../../components/Projects/ProjectDetails";      
    ...
    function Tasks() {
        ...
        useEffect(() => {
            // Appeler l'endpoint pour récupérer les détails du projet
            const email = 'r@Vermeg.com'; // Email à utiliser
            axios.get(`http://localhost:3000/api/ProductOwners/get-Project`, {
                params: { emailPo: email }
            })
            .then(response => {
                setProjectDetails(response.data[0]); // Stocker les détails du premier projet dans l'état local
                    ...
                    <div className="row g-3 row-deck">
                        ...
                        {projectDetails && (
                                <ProjectDetails 
                                    ...
                                    projectAssignedTeams={projectDetails.projectAssignedTeams.name}       
                                    budget={projectDetails.budget}
                                    priority={projectDetails.priority} 
                                    emailProductOwner={projectDetails.emailPo} 
                                />
                            )}
                        </div>
