...
function CurrenTProject(props) {
    ...
    <div 
        style={{ 
            ...
            height: "130px",
            borderRadius: "50%",
            overflow: "hidden", // Masquer le contenu qui dépasse du cercle
            backgroundColor: "rgba(0, 0, 0, 0.5)", // Arrière-plan transparent
    ...
    >
        <video autoPlay loop muted className="video-background" width="100%" height="100%">
   ...
   <div className="d-flex align-items-center justify-content-between mt-5">
              ...
              Client  {ClientName}
                    ...
                    {!Delivered &&  <button type="button" className="btn btn-outline-secondary" onClick={onClickEdit}><FiEdit /></button>}
                    {!Delivered &&     <button type="button" className="btn btn-outline-secondary" onClick={onClickDelete}><FiTrash2 /></button>}
                        {!Delivered && <Button className="bg-secondary" onClick={onClickDeliver}>Deliver Project</Button>}
                    </div>
                </div>
