...
function OurClients(props) {
    const {role, nom, type, experiences,email } = props;
            ...
            <div className="card-body d-flex">
                <div className="profile-av pe-xl-4 pe-md-2 pe-sm-4 pe-4 text-center w220">
                    ...
                    <div className="about-info d-flex align-items-center mt-1 justify-content-center flex-column">
                        <h6 className="mb-0 fw-bold d-block fs-6 mt-2">{nom}</h6>
                ...
                <div className="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                    <h6 className="mb-0 mt-2 fw-bold d-block fs-6">{nom}</h6>
                    <span className="light-info-bg py-1 px-2 rounded-1 d-inline-block fw-bold small-11 mb-0 mt-1">{type}</span>
                    <div className="video-setting-icon mt-3 pt-3 border-top">
                        <p>{experiences.length > 0 ? experiences[0].description : "No description provided"}</p>
                    </div>
